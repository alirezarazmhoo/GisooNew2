...
namespace Gisoo.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        public IActionResult Create([Bind("id,image,movie,link,imageUrl,movieUrl,isForWebSite,titleForWebSite")] Slider slider)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,image,movie,link,imageUrl,movieUrl,isForWebSite,titleForWebSite")] Slider slider)
        {
            if (id != slider.id)
            {
                return NotFound();
