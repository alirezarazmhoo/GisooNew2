...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class SearchAdvertismentController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;

        public SearchAdvertismentController(Context context,INotice notice)
        {
            _context = context;
            _notice = notice;
        }
    ...
    [HttpPost]
        public object GetAdvertisments(ProductSearch2 searchNotice)
        {
            ...
            if (searchNotice.isWorkshop != null)
                result = result.Where(x => x.isWorkshop == searchNotice.isWorkshop);
