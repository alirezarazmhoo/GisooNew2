...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class ConfirmLadderAdvertismentController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;
        private readonly IHostingEnvironment environment;

        public ConfirmLadderAdvertismentController(Context context, INotice notice, IHostingEnvironment environment)
        {
