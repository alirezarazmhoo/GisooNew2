...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class ConfirmLadderAdvertismentFromWebController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;
        private readonly IHostingEnvironment environment;

        public ConfirmLadderAdvertismentFromWebController(Context context, INotice notice, IHostingEnvironment environment)
        {
