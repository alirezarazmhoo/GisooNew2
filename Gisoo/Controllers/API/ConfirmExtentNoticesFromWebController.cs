...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class ConfirmExtentNoticesFromWebController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;
        private readonly IHostingEnvironment environment;

        public ConfirmExtentNoticesFromWebController(Context context, INotice notice, IHostingEnvironment environment)
        {
