...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class ConfirmLadderNoticesFromWebController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;
        private readonly IHostingEnvironment environment;

        public ConfirmLadderNoticesFromWebController(Context context, INotice notice, IHostingEnvironment environment)
        {
