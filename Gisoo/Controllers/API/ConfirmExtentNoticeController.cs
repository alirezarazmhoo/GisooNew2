...
namespace Gisoo.Controllers.API
{
    ...
    [ApiController]
    public class ConfirmExtentNoticeController : ControllerBase
    {
        private readonly Context _context;
        private INotice _notice;
        private readonly IHostingEnvironment environment;

        public ConfirmExtentNoticeController(Context context, INotice notice, IHostingEnvironment environment)
        {
